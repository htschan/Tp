...
//----------------------
// <auto-generated>
//     Generated using the NSwag toolchain v11.0.0.0 (NJsonSchema v9.1.2.0) (http://NSwag.org)
// </auto-generated>
//----------------------
...
export interface ITpClient {
     ...
     * @credentialVm Eine ASCII-Zeichenfolge mit mindestens einem Zeichen.
     * @return AuthResponse
     */
    authenticate(credentialVm: CredentialVm): Observable<AuthResponse | null>;
    /**
     * Einen Benutzer registrieren [AllowAnonymous]
     * @registerVm Registrierungsinformationen
     * @return Die Operation war erfolgreich. Der Benutzer erhält eine E-Mail mit einem Bestätigungslink.
     */
    registerUser(registerVm: RegisterVm): Observable<RegisterResponse | null>;
    /**
     ...
     */
    getPunches(): Observable<Punch[] | null>;
    /**
    ...
    /**
     * Retrieves all punches of current user of this year
     ...
     */
    punchIn(): Observable<PunchResponse | null>;
    /**
     * Erzeugt einen Zeitstempel
     * @return Unexpected error
     */
    punchOut(): Observable<PunchResponse | null>;
    /**
     * Modifiziert einen Zeitstempel
     * @return Unexpected error
     */
    punchModify(modifyPunchViewModel: ModifyPunchVm): Observable<PunchResponse | null>;
    /**
     * Modifiziert einen Zeitstempel
     * @return Unexpected error
     */
    punchModifyAdmin(modifyPunchAdminParams: ModifyPunchAdminParams): Observable<PunchResponse | null>;
    /**
     * Setzt den Status der Monatsabrechung
     * @return Unexpected error
     */
    punchSetStatusAdmin(setStatusAdminParams: SetStatusAdminParams): Observable<PunchResponse | null>;
}
...
export class TpClient implements ITpClient {
    ...
    authenticate(credentialVm: CredentialVm): Observable<AuthResponse | null> {
        ...
        const content_ = JSON.stringify(credentialVm ? credentialVm.toJSON() : null);
    ...
    registerUser(registerVm: RegisterVm): Observable<RegisterResponse | null> {
        ...
        const content_ = JSON.stringify(registerVm ? registerVm.toJSON() : null);
    ...
    recoverPassword(recoverPasswordParams: RecoverPasswordParams): Observable<RecoverPasswordResponse | null> {
        ...
        const content_ = JSON.stringify(recoverPasswordParams ? recoverPasswordParams.toJSON() : null);
    ...
    recoverUsername(recoverUsernameParams: RecoverUsernameParams): Observable<RecoverUsernameResponse | null> {
        ...
        const content_ = JSON.stringify(recoverUsernameParams ? recoverUsernameParams.toJSON() : null);
    ...
    setPassword(setPasswordParams: SetPasswordParams): Observable<SetPasswordResponse | null> {
        ...
        const content_ = JSON.stringify(setPasswordParams ? setPasswordParams.toJSON() : null);
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            ...
            if (response_ instanceof Response) {
                try {
                    ...
                    return <Observable<Punch[]>><any>Observable.throw(e);
                }
            } else
                return <Observable<Punch[]>><any>Observable.throw(response_);
        });
    }

    protected processGetPunches(response: Response): Observable<Punch[] | null> {
        const status = response.status; 

        if (status === 200) {
            const _responseText = response.text();
            let result200: Punch[] | null = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            if (resultData200 && resultData200.constructor === Array) {
                result200 = [];
                for (let item of resultData200)
                    result200.push(Punch.fromJS(item));
            }
            return Observable.of(result200);
        } else {
            const _responseText = response.text();
    ...
    protected processPunchIn(response: Response): Observable<PunchResponse | null> {
        const status = response.status; 
    ...
    protected processPunchOut(response: Response): Observable<PunchResponse | null> {
        const status = response.status; 
    ...
    punchModify(modifyPunchViewModel: ModifyPunchVm): Observable<PunchResponse | null> {
        ...
        const content_ = JSON.stringify(modifyPunchViewModel ? modifyPunchViewModel.toJSON() : null);
    ...
    punchModifyAdmin(modifyPunchAdminParams: ModifyPunchAdminParams): Observable<PunchResponse | null> {
        ...
        const content_ = JSON.stringify(modifyPunchAdminParams ? modifyPunchAdminParams.toJSON() : null);
    ...
    punchSetStatusAdmin(setStatusAdminParams: SetStatusAdminParams): Observable<PunchResponse | null> {
        ...
        const content_ = JSON.stringify(setStatusAdminParams ? setStatusAdminParams.toJSON() : null);
...
export class CredentialVm implements ICredentialVm {
    ...
    constructor(data?: ICredentialVm) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CredentialVm {
        let result = new CredentialVm();
        result.init(data);
        return result;
    }
...
export interface ICredentialVm {
    /** Die E-Mail Adresse 1 .. 160 Zeichen. Wird benötigt für die Bestätigung der Kontoerstellung. */
    email?: string | undefined;
    /** Das Passwort 1 .. 80 Zeichen. Wird für die Anmeldung benötigt. */
    password?: string | undefined;
...
export class PunchResponse implements IPunchResponse {
    status?: OpResult | undefined;
    data?: DayPunchesArray | undefined;
    ...
    init(data?: any) {
        if (data) {
            this.status = data["status"] ? OpResult.fromJS(data["status"]) : <any>undefined;
            this.data = data["data"] ? DayPunchesArray.fromJS(data["data"]) : <any>undefined;
        }
    }
...
export class DayResponse implements IDayResponse {
    status?: OpResult | undefined;
    punches?: DayPunchesVm | undefined;
    ...
    init(data?: any) {
        if (data) {
            this.status = data["status"] ? OpResult.fromJS(data["status"]) : <any>undefined;
            this.punches = data["punches"] ? DayPunchesVm.fromJS(data["punches"]) : <any>undefined;
        }
    }
...
export class WeekResponse implements IWeekResponse {
    status?: OpResult | undefined;
    punches?: WeekPunchesVm | undefined;
    ...
    init(data?: any) {
        if (data) {
            this.status = data["status"] ? OpResult.fromJS(data["status"]) : <any>undefined;
            this.punches = data["punches"] ? WeekPunchesVm.fromJS(data["punches"]) : <any>undefined;
        }
    }
...
export class MonthResponse implements IMonthResponse {
    status?: OpResult | undefined;
    punches?: MonthPunchesVm | undefined;
    ...
    init(data?: any) {
        if (data) {
            this.status = data["status"] ? OpResult.fromJS(data["status"]) : <any>undefined;
            this.punches = data["punches"] ? MonthPunchesVm.fromJS(data["punches"]) : <any>undefined;
        }
    }
...
export class YearResponse implements IYearResponse {
    status?: OpResult | undefined;
    punches?: YearPunchesVm | undefined;
    ...
    init(data?: any) {
        if (data) {
            this.status = data["status"] ? OpResult.fromJS(data["status"]) : <any>undefined;
            this.punches = data["punches"] ? YearPunchesVm.fromJS(data["punches"]) : <any>undefined;
        }
    }
...
export class YearPunchesVm implements IYearPunchesVm {
    /** Boid of user */
    ...
    constructor(data?: IYearPunchesVm) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (data) {
            ...
            if (data["punches"] && data["punches"].constructor === Array) {
                ...
                for (let item of data["punches"])
                    this.punches.push(MonthPunchesVm.fromJS(item));
            }
        }
    }

    static fromJS(data: any): YearPunchesVm {
        let result = new YearPunchesVm();
        result.init(data);
        return result;
    }
...
export interface IYearPunchesVm {
    /** Boid of user */
    user?: string | undefined;
    /** The year expressed as 1 to 9999 */
    year?: number | undefined;
...
export class MonthPunchesVm implements IMonthPunchesVm {
    /** Boid of user */
    user?: string | undefined;
    ...
    constructor(data?: IMonthPunchesVm) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            if (data["punches"] && data["punches"].constructor === Array) {
                this.punches = [];
                for (let item of data["punches"])
                    this.punches.push(DayPunchesVm.fromJS(item));
            }
        }
    }

    static fromJS(data: any): MonthPunchesVm {
        let result = new MonthPunchesVm();
        result.init(data);
        return result;
    }
...
export interface IMonthPunchesVm {
    /** Boid of user */
    user?: string | undefined;
    /** The month expressed as value between 1 and 12 */
    month?: number | undefined;
...
export class WeekPunchesVm implements IWeekPunchesVm {
    /** Boid of user */
    user?: string | undefined;
    ...
    /** The year expressed as 1 to 9999 */
    year?: number | undefined;
    dayPunches?: DayPunchesVm[] | undefined;

    constructor(data?: IWeekPunchesVm) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (data) {
            ...
            if (data["dayPunches"] && data["dayPunches"].constructor === Array) {
                ...
                for (let item of data["dayPunches"])
                    this.dayPunches.push(DayPunchesVm.fromJS(item));
            }
        }
    }

    static fromJS(data: any): WeekPunchesVm {
        let result = new WeekPunchesVm();
        result.init(data);
        return result;
    }
...
export interface IWeekPunchesVm {
    /** Boid of user */
    user?: string | undefined;
    /** The week expressed as 1 to 53 */
    week?: number | undefined;
...
export class DayPunchesArray implements IDayPunchesArray {
    punches?: DayPunchesVm[] | undefined;

    constructor(data?: IDayPunchesArray) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): DayPunchesArray {
        let result = new DayPunchesArray();
        result.init(data);
        return result;
    }
...
export interface IDayPunchesArray {
    punches?: DayPunchesVm[] | undefined;
}

export class DayPunchesVm implements IDayPunchesVm {
    /** Boid of user */
    ...
    constructor(data?: IDayPunchesVm) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            if (data["punches"] && data["punches"].constructor === Array) {
                this.punches = [];
                for (let item of data["punches"])
                    this.punches.push(Punch.fromJS(item));
            }
            this.daytotal = data["daytotal"];
        }
    }

    static fromJS(data: any): DayPunchesVm {
        let result = new DayPunchesVm();
        result.init(data);
        return result;
    }
...
export interface IDayPunchesVm {
    /** Boid of user */
    userboid?: string | undefined;
    /** The day expressed as value betwenn 1 and 31 */
    day?: number | undefined;
...
export class Punch implements IPunch {
    ...
    static fromJS(data: any): Punch {
        let result = new Punch();
        result.init(data);
        return result;
    }
