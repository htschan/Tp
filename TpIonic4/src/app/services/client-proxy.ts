...
export class TpProfileClient {
    ...
    getMyProfile(): Observable<ProfileResponseDto | null> {
        let url_ = this.baseUrl + "/api/v1/profile/getMyProfile";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetMyProfile(response: HttpResponseBase): Observable<ProfileResponseDto | null> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    getUserProfile(userid: string | null): Observable<ProfileResponseDto | null> {
        let url_ = this.baseUrl + "/api/v1/profile/getUserProfile/{userid}";
    ...
    protected processGetUserProfile(response: HttpResponseBase): Observable<ProfileResponseDto | null> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
